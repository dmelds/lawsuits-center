...
- 1. Add this line just before </body> on each case-review page:
- ```
...
var ERROR_COLOR = “#e07a5f”; // muted red, reads on both light and dark backgrounds
...
input.addEventListener("blur", function () {
  // Don't pop an error if the field is empty and the user never touched it
...
input.addEventListener("input", function () {
  input.dataset.touched = "true";
  // Clear the error message live as the user starts correcting
  var existing = input.parentNode.querySelector(
